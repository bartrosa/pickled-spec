"""MCP server CLI for pickled-schema."""
...
from pickled_schema.mcp_tools import register_with_fastmcp
...
def build_server() -> FastMCP:
    """Entry point for ``pickled.mcp.subservers``."""
    app = FastMCP("pickled-schema")
