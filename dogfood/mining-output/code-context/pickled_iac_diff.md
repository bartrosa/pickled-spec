...
- **Units collected:** 3 | **Total lines:** 102 | **Truncated:** False

## Root: pickled_iac.cli.diff
...
## Callee: pickled_iac.PlanDiffGate.run (hop 1)
...
## Callee: pickled_iac._index_changes (hop 2)
